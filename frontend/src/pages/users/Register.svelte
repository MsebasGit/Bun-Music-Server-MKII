...
>
  <div class="w-full max-w-sm">
    ...
    <form on:submit|preventDefault={handleSignup} class="max-w-sm mx-auto">
      <div class="mb-5">
        <label for="user" class="block mb-2.5 text-sm font-medium text-gray-900"
          >Usuario</label
        >
        <input
          type="text"
      ...
      <div class="mb-5">
        <label
          for="email"
          class="block mb-2.5 text-sm font-medium text-gray-900">Tu email</label
        >
        <input
          type="email"
          id="email"
      ...
      <p class="mt-4 text-sm font-light text-gray-500">
        ¿Ya tienes cuenta? <a
          href="/login"
          class="font-medium text-blue-600 hover:underline">Ingresa aquí</a
        >
      </p>
    </form>
  </div>
